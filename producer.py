...
logging.info('date=%s', ('Articles are pulled between', from_date, 'and', to_date))
...
logging.info('date=%s', ('Retrieved Articles between', from_date, 'and', to_date, '=', all_articles['totalResults']))
